...
export default function CompanyDashboard() {
  ...
  const normalizeData = (rawData) => {
    ...
    return rawData.map(item => ({
      ...
      frequency: item.frequency || item["Frequency %"] || item.frequency_percent || "0%",
    }));
  };
  ...
  useEffect(() => {
    ...
    setLoading(true);
    // Dynamic import of the company's JSON data
            ...
            <div className="space-y-6">
              <div className="flex flex-col md:flex-row md:items-end justify-between gap-4">
                <div className="space-y-1">
                  <h2 className="text-3xl font-black text-white tracking-tight">Questions</h2>
                  <p className="text-gray-500 font-medium">Practice most frequent {company.name} questions</p>
                </div>
